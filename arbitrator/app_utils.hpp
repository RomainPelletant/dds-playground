...
#ifndef FASTDDS_CPP_ARBITRATOR__APP_UTILS_HPP
#define FASTDDS_CPP_ARBITRATOR__APP_UTILS_HPP
...
struct TypeConverter
{
            ...
            const OwnershipRequestType& request)
    {
        ...
        request_ss << "request string"; //<< " " << to_string(request.operation()) << " " << request.y();
...
#endif // FASTDDS_CPP_ARBITRATOR__APP_UTILS_HPP
