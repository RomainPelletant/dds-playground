...
#ifndef FASTDDS_CPP_ARBITRATOR__CLIPARSER_HPP
#define FASTDDS_CPP_ARBITRATOR__CLIPARSER_HPP
...
public:
            ...
            const std::uint8_t return_code)
    {
        ...
        std::cout << ""                                                          << std::endl;
        std::cout << "Usage: arbitrator <entity> [options] [arguments]"          << std::endl;
        std::cout << ""                                                          << std::endl;
        std::cout << "Example:"                                                  << std::endl;
        std::cout << "  - arbitrator server"                                     << std::endl;
        std::cout << "  - arbitrator client 1 20"                                << std::endl;
        std::cout << ""                                                          << std::endl;
        ...
        std::cout << "[SERVICE] [STRENGTH] SERVICE:    1PH/2Console/3ScanIface"  << std::endl;
        std::cout << "                    STRENGTH: current Ownership Strength"  << std::endl;
...
private:
    ...
    static void consume_client_arguments(
            ...
            config& config)
    {
        config.service = consume_int16_argument(argv[2]);
        config.strength = consume_int16_argument(argv[3]);
    }
...
#endif // FASTDDS_CPP_ARBITRATOR__CLIPARSER_HPP
