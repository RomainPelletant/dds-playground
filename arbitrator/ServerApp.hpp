...
#ifndef FASTDDS_CPP_ARBITRATOR__SERVERAPP_HPP
#define FASTDDS_CPP_ARBITRATOR__SERVERAPP_HPP
...
//             std::int32_t& result);
    ...
    {
        SampleInfo info;
        std::shared_ptr<OwnershipRequestType> request;
    };
    ...
    /** @brief atomic boolean representing locked state
     * for thread-safety.
     */
    std::atomic<bool> m_lock_state;
...
#endif /* FASTDDS_CPP_ARBITRATOR__SERVERAPP_HPP */
