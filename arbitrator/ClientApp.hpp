...
#ifndef FASTDDS_CPP_ARBITRATOR__CLIENTAPP_HPP
#define FASTDDS_CPP_ARBITRATOR__CLIENTAPP_HPP
...
private:
    ...
    std::pair<std::int32_t, std::uint32_t> request_input_;
...
#endif /* FASTDDS_CPP_ARBITRATOR__CLIENTAPP_HPP */
